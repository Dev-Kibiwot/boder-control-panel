...
class RidersPage extends StatelessWidget {
                    ...
                    Expanded(
                      child: CustomDataTable<Map<String, dynamic>>(
                        ...
                        onRowTap: (riderMap) {
                          ...
                          Get.dialog(
                            RiderDetailsDialog(rider: rider),
      ...
      () => Row(
        children: [
          Expanded(
            child: buildStatCard(
              'Total Riders',
              ridersController.totalRiders.toString(),
              Icons.motorcycle,
              AppColors.blue,
            ),
          ),
          ...
          Expanded(
            child: buildStatCard(
              'Approved',
              ridersController.approvedRiders.toString(),
              Icons.check_circle,
              AppColors.success,
            ),
          ),
          ...
          Expanded(
            child: buildStatCard(
              'Pending',
              ridersController.pendingRiders.toString(),
    ...
    return Obx(
      () => Row(
        children: [
          ...
          if (ridersController.selectedFilter.value !=
                  ApprovalFilter.all ||
              ridersController.selectedvehecle.value !=
                  VehecleType.all)
            Padding(
  ...
  List<TableColumn> buildTableColumns() {
    return [
      TableColumn(
        header: 'RIDER',
        key: 'rider',
      ...
      TableColumn(
        ...
        customWidget: (value, item) {
          final rider = Rider.fromMap(item);
          final color = rider.verification.isApproved
              ? AppColors.success
              : AppColors.warning;
          final statusText = rider.approved
              ? 'Approved'
              : 'Pending';
          return Center(
            child: CustomText(
